 ...
 */
package com.youyou.shopping.system;
 ...
 * @Description: UncaughtException处理日志，当程序发生Uncaught异常的时候，由该类来接管程序,并记录发送错误报告
 * @author: Zaffy
 * @date:2012-8-1 下午5:38:04
 */
...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    private MyLogger log = MyLogger.getLogger("CrashHandler");
    ...
    public void uncaughtException(Thread thread, Throwable ex) {
        if (!handleException(ex) && mDefaultHandler != null) {
            ...
            SPApplication.getInstance().exit();
    ...
    private boolean handleException(final Throwable ex) {
        ...
        new Thread() {
            ...
            public void run() {
                Looper.prepare();
                ToastMaster.makeText(mContext, R.string.app_exit, Toast.LENGTH_SHORT);
                Looper.loop();
            }
        }.start();
        // 收集设备参数信息
    ...
    @Background
    void addLogToServer(StringBuffer sb) {
        if (sb == null) {
            return;
        }
        //上传到umeng服务器
    ...
    private String saveCrashInfo2File(Throwable ex) {
        ...
        try {
            ...
            if (Environment.getExternalStorageState().equals(
                ...
                String path = BaseConstants.path.LOG_DIR + File.separator;
