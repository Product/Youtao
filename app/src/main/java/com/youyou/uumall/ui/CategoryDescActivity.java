...
public class CategoryDescActivity extends BaseActivity implements BaseBusiness.ArrayListCallbackInterface,BrandDescGridAdapter.OnItemClickListener, RefreshListView.OnRefreshListener {
    @ViewById
    ...
    public void onRefreshing(boolean isAuto) {
        categoryDescBiz.queryGoodsByCategory(mId);
    }
}
