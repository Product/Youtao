...
public class CategoryDescActivity extends BaseActivity implements BaseBusiness.ArrayListCallbackInterface, AdapterView.OnItemClickListener {
    @ViewById
    ...
    void afterViews() {
        ...
        categoryDescBiz.queryGoodsByCategory(id);
