...
public class QueryMainAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        imageLoader.displayImage(BaseConstants.connection.ROOT_URL + leftitem.image, left_commodity_img,options);
        ...
        if (position * 2 + 1 < list.size()) {
            ...
            imageLoader.displayImage(BaseConstants.connection.ROOT_URL + rightitem.image, left_commodity_img,options);
